...
namespace NzbDrone.Core.MetadataSource.SkyHook
{
    public class SkyHookProxy : IProvideMovieInfo, ISearchForNewMovie, IDiscoverNewMovies
    {
        ...
        public Tuple<Movie, List<Person>> GetMovieInfo(int tmdbId, Profile profile = null, bool hasPreDBEntry = false)
        {
            ...
            return new Tuple<Movie, List<Person>>(movie, people);
        }
        ...
        private static Person MapCast(CastResource arg)
        {
            var newActor = new Person
            {
                Name = arg.Name,
                CastCharacter = arg.Character,
                Order = arg.Order,
                TmdbId = arg.Id,
        ...
        private static Person MapCrew(CrewResource arg)
        {
            var newActor = new Person
            {
                Name = arg.Name,
                CrewDepartment = arg.Department,
                CrewJob = arg.Job,
                TmdbId = arg.Id,
